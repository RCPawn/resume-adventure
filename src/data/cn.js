...
export default {
    ...
    projects: {
        items: [
            {
                name: "非遗数字展厅",
                description: "针对白族非遗文化设计的数字双生平台，实现 3D 展品全方位展示、实时动态统计与高交互讨论。"
            },
            {
                name: "榄人千里眼",
                description: "油橄榄园区一体化平台，融合数据可视化、WebGIS与区块链技术的全域资产管理平台"
    ...
    resume: {
            ...
            categories: [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        "熟练掌握 MyBatis 框架，能编写 SQL 满足基本业务需求，理解索引优化、事务隔离级别与锁机制；"
                    ]
                },
                {
                    name: "存储与交互",
            ...
            items: [
                {
                    ...
                    description: "项目描述：针对白族非遗文化设计的数字双生平台，实现 3D 展品全方位展示、实时动态统计与高交互讨论。",
                    stack: "Spring Boot、Vue3、WebGL (model-viewer)、MyBatis、MySQL",
                    contributions: [
                        "依托成熟框架完成系统全链路开发，参考得物设计规范重塑高保真交互布局，攻克 3D 非遗物品上传存储与 Web 端实时渲染展示难题，实现从数据建模到终端展示的技术闭环。",
                ...
                },
                {
                    ...
                    description: "项目描述：实验室合作项目，为企业开发的农业资产数字化管理平台，覆盖 12 个管区、1000+ 台设备（捕虫灯、割草机等），预计上线后可降低企业运维成本 30%+。",
                    stack: "Spring Boot、MySQL、Redis、MyBatis",
                    contributions: [
                        "引入状态机设计模式驱动资产全生命周期管理（入库、调拨、报修、报废），提升资产台账准确性及利用率。",
                        "利用 Redis 对高频访问的设备地理位置与运行状态进行缓存，显著降低了林区大地图渲染时的数据穿透压力。",
        ...
        algo: {
            title: "算法能力",
            items: [
                "力扣刷题 300+ 道，熟练掌握动态规划、深度优先搜索、回溯等常用算法方案",
                "熟悉常见算法复杂度分析与优化方法",
                "享受代码 AC 的过程，具备良好的算法思维"
            ]
        },
        courses: {
            title: "专业课程",
            items: [
                "计算机基础：数据结构、算法分析、计算机组成原理、计算机网络、操作系统",
                "开发技术：JavaEE 企业级开发、数据库概论、Web 前端开发",
        ...
        softSkills: {
            title: "综合素质",
            items: [
                "踏实自律：在考研备考期间仍保持高频代码提交，具备极强的时间管理能力",
                "逻辑严密：在开发中关注边界条件，习惯通过排查日志定位底层 Bug",
                "沟通协作：善于倾听与表达，能够与不同角色的成员配合完成任务"
            ]
        }
    },
    footer: {
